			...
			if @options.images
				...
				createItem = (el) =>
					...
					if @detectImage src
						...
						"""<div class="slick-lightbox-slick-item"><div class="slick-lightbox-slick-item-inner iframe"><div class="slick-lightbox-slick-iframe-wrap"><iframe class="slick-lightbox-slick-iframe" src="#{ src }" frameborder="0" allowfullscreen></iframe>#{ caption }</div></div></div>"""
		...
		bindEvents: ->
			...
			if @options.closeOnBackdropClick
				@modalElement.on 'click.slickLightbox touchstart.slickLightbox', '.slick-lightbox-slick-img', (e) =>
					e.stopPropagation()
				@modalElement.on 'click.slickLightbox touchstart.slickLightbox', '.slick-lightbox-slick-iframe-wrap', (e) =>
					e.stopPropagation()
